...
class m150517_085614_user extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%user}}', $columns, [
            [
                ...
                'meelis@doge.ee',
                'meelis',
                '$2y$13$SDNvU9DXdTzh07z4ug.mEuEOecstyU0qAEVSzbQFl6OVp39hZXevi',
                User::STATUS_ACTIVE,
                date('Y-m-d H:i:s'),
            ...
            [
                ...
                'marika@doge.ee',
                'marika',
                '$2y$13$TXFUqvcIh/L8EcPMsXyL/eVvXLdCgau1ZFT/TF7D6x.PtLHWAHDaG',
                User::STATUS_ACTIVE,
                date('Y-m-d H:i:s'),
                $security->generateRandomString(),
                $security->generateRandomString(),
        ...
        $this->batchInsert('{{%profile}}', $columns, [
            [1, 'Meelis Kingsepp', date('Y-m-d H:i:s')],
            [2, 'Marika (the pagar) Kukkel', date('Y-m-d H:i:s')],
        ]);
    }
